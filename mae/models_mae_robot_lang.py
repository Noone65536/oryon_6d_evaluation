...
class MAERobotLang(MAERobot):
    ...
    def get_representations(
        ...
        if language is None:
            ...
            lang, lang_mask = tokens["input_ids"].to('cuda'), tokens["attention_mask"].to('cuda')
        ...
        latent2, mask2, ids_restore2 = self.forward_encoder(imgs, mask_ratio=1.0)
        lang_emb = self.get_lang_embed_kws(lang)
